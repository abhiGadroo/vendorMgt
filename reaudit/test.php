...
<div class="alert alert-info">
		<center><strong>INFO!</strong> You are Re-Auditing <?php echo $_SESSION['target_vendor']; ?> for the quater <?php if (date("m")/3 <=3 and date("m")/3 >2){echo "JAS";} 
	elseif (date("m")/3 <=1) {echo "JFM";} 
	elseif (date("m")/3 <=2 and date("m")/3 >1){echo "AMJ";}
	elseif (date("m")/3 <=4 and date("m")/3 >3){echo "OND";}
	echo " - ";
	echo date("Y");?> </center>
		</div>
