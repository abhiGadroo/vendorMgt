...
<div class="alert alert-info">
		<center><strong>INFO!</strong> You are Re-Auditing <?php echo $_SESSION['target_vendor']; echo $_SESSION['process'];?> for the quater <?php if (date("m")/3 <=3 and date("m")/3 >2){echo $_SESSION['reaudit_quater']=  "JAS";} 
