...
<center><h4>Sheet Metal Score Sheet</h4></center>

<!-- New Block Here -->

<form id = "csvdform" action="/testscores/sheetmetalcheck.php/" method ="POST">
<div class="container" style= "<?php echo ($type == 'VD')?'display:block':'display:none';?>"> 
  ...
  <tr><td>Types of machines , Variety of press machines in the press shop </td><td><input type="text" name="cm1" required> </td></tr>
  <tr><td>Number of machines and capacity of all the machines with the vendor</td> <td><input type="text" name="cm2" required></td> </tr>
...
<p>In this we check if the vendor has the right quality systems laid down which ensure that the material will be of good quality and will be defect free and in case a defect arises the vendor will do the anaysis and try to close it.</p>
  ...
  <tr><td>Special focus on Forming and Profiles , No Spring Back , Trimming and Hole Profile / Finish for any of the existing parts vendor is manufacturing and is in running production. </td> <td><input type="text" name="apf2" required></td> </tr>
  <tr><td>No burr , fine boarders , measuring guages , jigs and fixtures should be there. </td> <td><input type="text" name="apf3" required></td> </tr>
  </table>
	</div>
