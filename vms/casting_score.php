...
<form id = "test2" action="/scores/actionpage.php/" method ="POST">
...
<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demox12">Packaging & Dispatch</button>
  ...
  <tr><td>Tracebility of al the lots produced & dispached .</td><td><input type="text" name="pd1" required> </td></tr>
	...
	<form id = "test3" action="/scores/actionpage.php/" method ="POST">
...
<p>In this section we try to evaluate if the vendor will be able to deliver the right product to us at the right time.</p>
  ...
  <div id="demoxx" class="collapse">
    <table>
  <tr><td>Possible Transit time for material from Domestic Vendor? </td><td><input type="text" name="gen1"> </td></tr>
  <tr><td>Whether vendor is having Raw Material Test Certificates ? </td><td><input type="text" name="gen2"> </td></tr>
  <tr><td>Does Vendor has Vendor selection process of their vendors ?</td><td><input type="text" name="gen3"> </td></tr>
  <tr><td>Total No. of Major OEM Clients ? </td><td><input type="text" name="gen4"> </td></tr>
  <tr><td>Does Vedor has any record of PPC in plant from last 6 months</td><td><input type="text" name="gen5"> </td></tr>
  <tr><td>Does Vendor has any ERP Process ? </td><td><input type="text" name="gen6"> </td></tr>
  <tr><td>Does Vendor keeping record of customer's feedback ? If, Yes then any action on those feedbacks ? </td><td><input type="text" name="gen7"> </td></tr>
  <tr><td>What is the mode of communication from top management to shop floor employee ?</td><td><input type="text" name="gen8"> </td></tr>
  <tr><td>What is the turnover in last financial year ?</td><td><input type="text" name="gen9"> </td></tr>
  <tr><td>Is Vendor Using FIFO for his Raw Material inventory ? </td><td><input type="text" name="gen10"> </td></tr>
  <tr><td>Is vendor using standard packing of material ?</td><td><input type="text" name="gen11"> </td></tr>
  <tr><td>Does vendor have Skill matrix of his shop floor employees ?</td><td><input type="text" name="gen12"> </td></tr>
  <tr><td>Does Vendor has defined place for RM, FG, SFG or Rejected Material ?</td><td><input type="text" name="gen13"> </td></tr>
  <tr><td>Does vendor has defined process for Internal rejected material ?</td><td><input type="text" name="gen14"> </td></tr>
  <tr><td>Does Vendor provide prompt and technical assistance to his customer, which helps in price reduction or quality improvement or lead time reduction ?</td><td><input type="text" name="gen15"> </td></tr>
  <tr><td>Does Vendor has defined process for handling customer complaints ?</td><td><input type="text" name="gen16"> </td></tr>
  <tr><td>Does Vendor has any process for handling ECN ?</td><td><input type="text" name="gen17"> </td></tr>
  <tr><td>Does Vendor has defined subcontracting process ?</td><td><input type="text" name="gen18"> </td></tr>
  <tr><td>Does Vendor has capability to increase the shifts ?</td><td><input type="text" name="gen19"> </td></tr>
  <tr><td>Does Vendor put identification on parts before dispatching ?</td><td><input type="text" name="gen20"> </td></tr>
  <tr><td>Does vendor has defined SOP or Work Instructions ?</td><td><input type="text" name="gen21"> </td></tr>
  </table>
